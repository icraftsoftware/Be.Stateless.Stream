...
namespace Be.Stateless.IO
{
	...
	public class BufferController
	{
		...
		/// </param>
		/// <returns>
		/// The <paramref name="bytes"/> sub-array, that is the array of bytes, that could not be appended to the underlying
		...
		/// </summary>
		/// <param name="bytes">
		/// An array of bytes. This method appends count bytes from <paramref name="bytes"/> to the underlying controlled buffer.
		/// </param>
		/// <param name="offset">
		/// The zero-based byte offset in <paramref name="bytes"/> at which to begin copying bytes to the underlying controlled
		/// buffer.
		/// </param>
		/// <param name="count">
		...
		/// <summary>
		/// Append an <see cref="IEnumerable{T}"/> of byte-array <paramref name="buffers"/> to the underlying controlled buffer.
		/// </summary>
		/// <param name="buffers">
		/// The <see cref="IEnumerable{T}"/> of byte-array <paramref name="buffers"/> to append to the underlying controlled
		/// buffer.
		/// </param>
		/// <returns>
		/// The <see cref="IEnumerable{T}"/> of byte-array buffers that could not be appended to the underlying controlled buffer
		/// because of availability shortage. Notice that no byte will be lost, and that the first buffer in the <see
